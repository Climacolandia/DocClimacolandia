...
{%
  ...
  \def\@maketitle{%
    ...
    \begin{flushleft}%
      ...
      {\sffamily \LARGE \@title \par}%
      \vskip 1em%
      {\sffamily \large\lineskip .75em\ramle ~-~ \elmarmatricula}\\%
      {\sffamily \large\lineskip .75em\ramle ~-~ \gabrielCmatricula}\\%
      {\sffamily \large\lineskip .75em\ramle ~-~ \gabrielVmatricula}\\%
      {\sffamily \large\lineskip .75em\ramle ~-~ \matheusmatricula}\\%
      %\vskip 1em%
      \sffamily \@date\\
      \vskip 1em%
...
%end exam
{
  ...
  \@ifclassloaded{IEEEtran}
  {
    ...
    \author{
      ...
      %conference
      \IEEEauthorblockN{\elmar}
      \IEEEauthorblockA{Matricula: \elmarmatricula\\E-mail: \eelmar}

      \IEEEauthorblockN{\gabrielC}
      \IEEEauthorblockA{Matricula: \gabrielCmatricula\\E-mail: \egabrielC}

      \IEEEauthorblockN{\gabrielV}
      \IEEEauthorblockA{Matricula: \gabrielVmatricula\\E-mail: \egabrielV}

      \IEEEauthorblockN{\matheus}
      \IEEEauthorblockA{Matricula: \matheusmatricula\\E-mail: \ematheus}
      % \and
